...
namespace Textbased_game
{
    class StationaryObjectData
    {
        public static Dictionary<string, string> stationaryObjectDescriptions = new Dictionary<string, string> {
          ...
          , { "Applejack's throne", "Applejack's throne. You can tell by the dried apple juice stains." }
          , { "Pinkie Pie's throne", "Pinkie Pie's throne. What marechiavellian part plans have been planned from this seat, you wonder?" }
